...
import { AgentsDynamicPage } from './AgentsDynamicPage';
import { ApprovalCenterPage } from './ApprovalCenterPage';
import { BackupRunsPage } from './BackupRunsPage';
import { GeneralPage } from './GeneralPage';
import { IdentityAsCodePage } from './IdentityAsCodePage';
...
export const settingsPage = (providerSettings: ProviderSetting[]) => (
  <SettingsLayout>
    ...
    <SettingsLayout.Route path="platform-control" title="Platform Control">
      <IdentityAsCodePage />
    </SettingsLayout.Route>
    <SettingsLayout.Route path="agent-hub" title="Agent Hub">
      <AgentsDynamicPage />
    </SettingsLayout.Route>
    <SettingsLayout.Route path="approvals" title="Approval Center">
      <ApprovalCenterPage />
    </SettingsLayout.Route>
    <SettingsLayout.Route path="backup-runs" title="Backup Runs">
      <BackupRunsPage />
    </SettingsLayout.Route>
  </SettingsLayout>
);
