...
import {
  ...
  aiOrchestratorBackend,
  cicdAgentBackend,
  dataSecurityAgentBackend,
  healthCheckPlugin,
...
if (
  ...
  // For now in SmartOps the old frontend application doesn't use standard module federation and, by default,
  // exported SmartOps dynamic frontend plugins don't contain standard module federation assets.
...
backend.add(identityAsCodeBackend);
